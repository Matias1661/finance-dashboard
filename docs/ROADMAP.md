...
- [x] Migración Relay → GitHub Actions — completada, Relay.app retirado por completo (22/08/2026, confirmado por el usuario; ver `DECISIONS.md` 2026-08-22) (ver `PROJECT_MEMORY.md`, sección "MIGRACIÓN COMPLETA", y `DECISIONS.md` 2026-07-17 para prompts ya probados):
  ...
  - [x] Talho Argentino / Gastos del local (paso 4.5 del plan): `scripts/process_gastos_talho.py` implementado y validado con los 33 comprobantes reales de la carpeta Drive (22/07/2026). Decision: Relay flujo "Drive → Notion" se apaga (reemplazado); Relay flujo "edición manual → refresh instantáneo" queda activo hasta que Relay deje de funcionar solo (ver `DECISIONS.md` 2026-07-22).
  - [x] Validar cada flujo con datos reales antes de apagar Relay (paso 5 del plan) — completado (MyInvestor validado 19 meses, Nóminas con nómina real de julio 31/07); ver `DECISIONS.md` 2026-08-22.
- [x] Alerta en el dashboard cuando falta subir la nómina de un mes (propuesta del usuario, 17/07): implementada en `js/insights.js` (`checkNominaFaltante()`, dentro de `#insights-card`, margen de gracia 5 días, mes de pago = último día hábil). Ver `DECISIONS.md` 2026-07-23 (2).
